...
(function () {
  ...
  function updateStaticUI() {
    ...
    const battleIntro = null;
    if (battleTitle) battleTitle.textContent = getText('sections.battleTitle', battleTitle.textContent);
    if (battleIntro) battleIntro.textContent = getText('sections.battleIntro', battleIntro.textContent);
